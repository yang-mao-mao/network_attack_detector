...
class StatisticWindow(QMainWindow):
    ...
    **real** data via the public ``add_alert`` and ``add_packet`` methods.
    ...
    def clear_data(self) -> None:
        """Remove all externally loaded packets and alerts from the dashboard."""
        self._attacks.clear()
        self._packets.clear()
        self._clock.set_attacks(self._attacks)
        self._detail_panel.clear_display()
        self._ranking_panel.clear_display()
    ...
    def _on_gen_csv_report(self) -> None:
        ...
        """
        from src.report.csv_exporter import generate_attack_report
    ...
    def _on_gen_html_report(self) -> None:
        ...
        """
        from src.report.html_reporter import generate_overall_report
